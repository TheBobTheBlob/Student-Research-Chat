    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tasks.map((task: any) => (
                <Card
                    key={task.task_uuid}
                    className="h-full transition-all duration-200 hover:shadow-md hover:border-blue-500/30 hover:bg-blue-50/50 dark:hover:bg-blue-950/20 group"
                >
                    <CardHeader className="flex flex-row items-start gap-4 space-y-0 pb-2">
                        ...
                        <div className="flex-1 min-w-0">
                            <CardTitle className="text-lg font-semibold leading-tight group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors">
                                {task.title}
                            </CardTitle>
