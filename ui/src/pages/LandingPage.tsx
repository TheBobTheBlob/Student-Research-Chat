...
import { ArrowRight, CheckCircle2, Github, MessageCircle, Shield, StickyNote, Users, Zap } from "lucide-react"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div className="flex flex-col items-center gap-4 p-6 rounded-2xl bg-blue-50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/50">
                                ...
                                <p className="text-muted-foreground">
                                    Your research data is protected - only people you give access to can view sensitive information.
                                </p>
                            </div>
